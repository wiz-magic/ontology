...
1. **Scan the index** — Pick objects relevant to the question from INDEX.md by title and summary; when in doubt, pick broadly. If the Objects section is split into sub-indexes (SCHEMA.md §7.1), read the sub-indexes of the relevant types.
